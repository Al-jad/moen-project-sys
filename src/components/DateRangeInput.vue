<template>
  <div class="relative">
    <Popover>
      <PopoverTrigger>
        <PrimaryButton
          variant="primary"
          class="flex w-auto min-w-56 flex-row justify-start"
          :class="[
            modelValue?.start
        ...
        >
          <div class="flex w-full flex-wrap items-center gap-2">
            ...
            <div v-if="isPremium" class="flex items-center gap-1 text-xs text-red-500">
      ...
      <PopoverContent v-if="!isPremium" class="w-auto p-0 dark:border-gray-700 dark:bg-gray-800">
        <RangeCalendar
          v-model="dateRange"
          :number-of-months="2"
  ...
  <!-- Premium Modal -->
  <PremiumModal v-if="isPremium" v-model:open="showPremiumModal" @close="showPremiumModal = false" />
</template>
