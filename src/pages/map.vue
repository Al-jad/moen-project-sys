      ...
      <div class="container mx-auto max-w-[90rem] p-4">
        ...
        <div class="rounded-xl bg-white/50 p-6 shadow-lg backdrop-blur-sm dark:bg-gray-800/50">
          ...
          >
            ...
            <PrimaryButton
              size="lg"
              :variant="selected === 'completed' ? 'custom' : 'outline'"
            ...
            <PrimaryButton
              size="lg"
              :variant="selected === 'inProgress' ? 'custom' : 'outline'"
              icon="lucide:loader"
            ...
            <PrimaryButton
              size="lg"
              :variant="selected === 'delayed' ? 'custom' : 'outline'"
            ...
            <PrimaryButton
              size="lg"
              :variant="selected === 'cancelled' ? 'custom' : 'outline'"
